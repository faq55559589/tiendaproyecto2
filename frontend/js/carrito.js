        ...
        return `
            <div class="cart-item border-bottom pb-3 mb-3" data-index="${index}">
                <div class="row align-items-center">
                    <div class="col-md-2">
                        <a href="producto.html" onclick="goToProduct('${item.name}')">
                            <img src="${item.image}" class="img-fluid rounded" alt="${item.name}" style="max-height: 80px; object-fit: cover; cursor: pointer; transition: transform 0.3s ease;">
                        </a>
                    </div>
                    <div class="col-md-4">
